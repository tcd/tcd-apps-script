...
declare namespace GoogleAppsScript {
  namespace Spreadsheet {
     ...
     *
     * See [the language reference](https://developers.google.com/apps-script/reference/spreadsheet/range) for more information.
     */
    interface Range {
      activate(): Range;
      ...
      /** Returns the formulas ([A1 notation](https://developers.google.com/sheets/api/guides/concepts)) for the cells in the Range. */
      getFormulas(): string[][];
      ...
      /**
       * Alias for {@link Range#getRowIndex}.
       *
     ...
     *
     * See [the language reference](https://developers.google.com/apps-script/reference/spreadsheet/sheet) for more information.
     */
    interface Sheet {
      activate(): Sheet;
     ...
     *
     * This class contains methods to access and modify existing slicers.
     *
     * To create a new slicer, use `Sheet.insertSlicer(range, anchorRowPos, anchorColPos)`.
     */
    interface Slicer {
     ...
     *
     * See [the language reference](https://developers.google.com/apps-script/reference/spreadsheet/spreadsheet) for more information.
     */
     ...
     *
     * See [the language reference](https://developers.google.com/apps-script/reference/spreadsheet/spreadsheet-app) for more information.
     */
